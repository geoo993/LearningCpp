...
public:
	...
	Test (Test &&other){ //this is a move constructor, usually you do not need const in R values references
...
int main() {
	...
	//the move constructor looks a lot like the copy constructor except that it uses R Value references
	vector<Test> vec;
	vec.push_back(Test());//vector is copying the Test object, doing it using the move constructor. and here we do not have to allocate any more memory in the copying of the constructor, this is better and more efficient than doing a copy constructor;
