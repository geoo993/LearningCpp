...
public:
	...
	bool operator==(const Complex &other) const;//comparison operator and finding out if the values are equal
	bool operator!=(const Complex &other) const;//comparison operator and finding out if the values are not equal
	bool operator<(const Complex &other) const;//comparison operator and arranging the values
